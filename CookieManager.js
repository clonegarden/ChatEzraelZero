...
function updateProfileCookie(req, res, messageContent = '') { 
  ...
  const profile = { 
    ...
    ips: Array.from(new Set([ip, ...(existing.ips || [])])).slice(0, 5), 
    modal_trace: (existing.modal_trace || []).slice(-10), 
